---
title: "Up and Running With Iterm & Zsh"
date: 2017-12-19T06:42:33-06:00
lastMod: 2017-12-19T06:42:33-06:00
draft: false
author: "Cody Brunner"
description: "Setting up iTerm2 with Zsh, Powerlevel9k, & integrating with VSCode."
type: "post"
keywords: ["iTerm2", "zsh", "powerlevel9k", "vscode", "shell", "cli", "terminal"]
tags: ["iTerm2", "zsh", "vscode", "shell", "cli"]
cloud: false
evil: true
flip: false
highlight: true
...
{{< image alt="a pic" id="term_left_side_5" ext="png" caption="view from home directory." >}}
{{< image alt="a pic" id="term_right_side" ext="png" caption="right side of prompt holds node & yarn version as well as time and date." >}}
{{< image alt="a pic" id="term_left_side" ext="png" caption="clean git repository." >}}
{{< image alt="a pic" id="term_left_side_2" ext="png" caption="dirty git repository." >}}
{{< image alt="a pic" id="term_left_side_3" ext="png" caption="modified git repository." >}}
{{< image alt="a pic" id="term_left_side_4" ext="png" caption="1 commit ahead of master." >}}
{{< image alt="a pic" id="in_vscode" ext="png" caption="view from inside vscode." >}}
